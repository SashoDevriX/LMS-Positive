<header class="site-header">
    ...
    <div id="nav-button" class="nav-button">
        <svg class="nav-open" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
            height="24">
        ...
        <svg class="nav-close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
            height="24">
            <path fill="none" d="M0 0h24v24H0z" />
            <path
